...
const NORMAL_CARDS = {
  attack: { label: '攻撃', initial: 5, price: 10 },
  defense: { label: '防御', initial: 5, price: 10 },
  scout: { label: '偵察', initial: 5, price: 10 },
  accusation: { label: '告発', initial: 5, price: 20 },
  heal: { label: '回復', initial: 1, price: 30 }
};
...
const SCORING = {
  attackHit: 10,
  defenseSuccess: 10,
  defenseOtherSuccess: 10,
  scoutSuccess: 10,
  healSelfSuccess: 10,
  healOtherSuccess: 20,
  accusationSuccess: 30,
  accusationFailure: -15,
  survival: 50,
  fullDefenseSuccess: 20,
  specifySuccess: 20
};

// ポイント泥棒：配分合計は最大40P、1人あたり最大20P。指定額を相手が持っていなければその相手からは0P。
const STEAL_MAX_TOTAL = 40;
const STEAL_MAX_PER_TARGET = 20;
const SPECIAL_PURCHASE_PRICE = 40;
const SPECIAL_SPECIFIED_PURCHASE_PRICE = 50;
...
module.exports = {
  ...
  SCORING, STEAL_MAX_TOTAL, STEAL_MAX_PER_TARGET, SPECIAL_PURCHASE_PRICE, SPECIAL_SPECIFIED_PURCHASE_PRICE, TURN_START_BONUSES, WINNER_BET, GOGI_CHIPS, baseHand, emptySpecials
};

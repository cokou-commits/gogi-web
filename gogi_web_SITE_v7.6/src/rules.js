...
// 行動専用フェーズは廃止。互換用の公開値だけ0秒で保持する。
const ACTION_SECONDS = 0;
...
const NORMAL_CARDS = {
  ...
  accusation: { label: '告発', initial: 3, price: 25 },
...
module.exports = {
  ...
  SCORING, STEAL_AMOUNTS, SPECIAL_PURCHASE_PRICE, TURN_START_BONUSES, WINNER_BET, baseHand, emptySpecials
};

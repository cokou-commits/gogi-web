...
const CLIENT_BUILD_ID = '20260912-lobbynoresume1';
...
function leaveCurrentRoom() {
  ...
  // 待機中は「切断＝完全退出」に戻す。
  // 復帰待ち・ACK待ち・HTTP退出待ちは作らず、Socket切断をサーバー側の即時退出として扱う。
  leavingLobby = true;
  ...
  // サーバーではlobby中のdisconnectを即時削除するため、ここでは待たずに切断する。
